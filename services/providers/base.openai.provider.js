...
module.exports = class BaseOpenAIProvider extends LlmServiceProvider {
  constructor(provider = "openai") {
    ...
    switch (provider) {
      case "openai":
        this.openai = new OpenAIClient(new OpenAIKeyCredential(this.config.LLMauthToken));
        break;
      default:
        this.openai = new OpenAIClient(this.config.LLMserverURL, new AzureKeyCredential(this.config.LLMauthToken), {
