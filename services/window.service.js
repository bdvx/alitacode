...
module.exports = class WindowService {
  getSelectedText() {
    ...
    const selRange = new vscode.Range(sel_start.line, sel_start.character, sel_end.line, sel_end.character);
    const selText = vscode.window.activeTextEditor.document.getText(selRange).trim();
